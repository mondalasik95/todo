...
<body>
  <div class="container">
    ...
    <button id="btnLoad" class="btn btn-outline-warning" >Load Todos of {{session()->get('USER')}}</button> |
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <input id="user_id_val" type="hidden" value="{{session()->get('USER-ID')}}">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input type="hidden" name="hid" id="hid" value="{{session()->get('USER-ID')}}"/>
        </div>
        <div class="form-group">
