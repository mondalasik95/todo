                ...
                'success':function(data,status){
                         ...
                         //console.log('Data :'+data);
                          if(status == 'success'){
                             ...
                             $('#result').html(`
                                      <h4><img src='<?php echo e(asset('./images/Ajax-loader.gif')); ?>' height='64px' width='64px'/> 
                                      Please wait ....</h4>
                                   `);
                             setTimeout(function(){
                                var todoData = data;
...
<body>
   <div class="container">
       <header class="modal-header"><h4>Displaying all Todos Info:</h4>
       <?php if(session()->has('USER')): ?>
   <div class="float-right">Welcome <?php echo e(session()->get('USER')); ?> 
                            <a href="#" onclick="onLogout()">Logout</a>

   </div>
   <?php else: ?>
     <script>window.location.href=`<?php echo e(url('/users')); ?>`;</script>
   <?php endif; ?>
   
    </header>
    
   <button id="btn" class="btn btn-outline-primary">Load Todos</button> |
...
<?php /**PATH C:\xampp\htdocs\EJOB-PHP2\laravel\myApp2\resources\views/ajax/index.blade.php ENDPATH**/ ?>